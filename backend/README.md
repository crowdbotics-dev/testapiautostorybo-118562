...
## Project Structure
    ...
    ├── testapiautostorybo_118562  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_118562`
...
2. Clone this repo and `cd testapiautostorybo_118562`
